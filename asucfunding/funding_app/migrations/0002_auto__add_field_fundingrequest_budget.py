...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FundingRequest.budget'
        db.add_column('funding_app_fundingrequest', 'budget',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['funding_app.Budget'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FundingRequest.budget'
        db.delete_column('funding_app_fundingrequest', 'budget_id')
