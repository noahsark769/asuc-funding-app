...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ConfigUGReqCat.config'
        db.delete_column('funding_app_configugreqcat', 'config_id')

        # Deleting field 'ConfigUGGrant.config'
        db.delete_column('funding_app_configuggrant', 'config_id')

        # Deleting field 'ConfigGradDelegate.config'
        db.delete_column('funding_app_configgraddelegate', 'config_id')

        # Deleting field 'ConfigAdmin.config'
        db.delete_column('funding_app_configadmin', 'config_id')

        # Deleting field 'ConfigGradReqCat.config'
        db.delete_column('funding_app_configgradreqcat', 'config_id')

        # Deleting field 'ConfigLocation.config'
        db.delete_column('funding_app_configlocation', 'config_id')

        # Deleting field 'ConfigFundingRound.config'
        db.delete_column('funding_app_configfundinground', 'config_id')

        # Deleting field 'ConfigGradGrant.config'
        db.delete_column('funding_app_configgradgrant', 'config_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ConfigUGReqCat.config'
        db.add_column('funding_app_configugreqcat', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)

        # Adding field 'ConfigUGGrant.config'
        db.add_column('funding_app_configuggrant', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)

        # Adding field 'ConfigGradDelegate.config'
        db.add_column('funding_app_configgraddelegate', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)

        # Adding field 'ConfigAdmin.config'
        db.add_column('funding_app_configadmin', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)

        # Adding field 'ConfigGradReqCat.config'
        db.add_column('funding_app_configgradreqcat', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)

        # Adding field 'ConfigLocation.config'
        db.add_column('funding_app_configlocation', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)

        # Adding field 'ConfigFundingRound.config'
        db.add_column('funding_app_configfundinground', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)

        # Adding field 'ConfigGradGrant.config'
        db.add_column('funding_app_configgradgrant', 'config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['funding_app.Config']),
                      keep_default=False)
