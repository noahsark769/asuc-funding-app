$(document).ready(function() {
		...
		// Initialize
	{
		...
		if ($('#request_form').hasClass('create')) {
			addTravelItemDescription();
			addTravelItemDescription();
			addTravelItemDescription();
		}
		else if ($('#request_form').hasClass('edit')) {
			$checked = $('input:radio:checked[name=request_type]');
			$('input:radio[name=request_type]').not(':checked').trigger('click');
